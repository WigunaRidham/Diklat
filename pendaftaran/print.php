...
<h3><center>Laporan data pendaftaran:</h3>
 ...
 <table width="80%" class="table table-striped table-bordered table-hover">
     <thead>
  <tr bgcolor="#cccccc">
        <th width="30%"><center>Kursus Dibuka</th>
    <th width="30%"><center>NRP/NIP</th>
    <th width="20%"><center>Tanggal Daftar</th>
  </tr>
  </thead>
  <tbody>
<?php  
  $sql="select * from `$tbpendaftaran`  order by `kd_kursus_dibuka` asc";
  $jum=getJum($conn,$sql);
		if($jum > 0){
	//--------------------------------------------------------------------------------------------									
