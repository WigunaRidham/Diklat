...
class PDF extends FPDF{
  function Header(){
    ...
    $this->Cell(20,0,'Data jadwal',0,0,'L');
    $this->Ln();
    $this->Cell(5,1,'Laporan data jadwal',0,0,'L');
    $this->Ln();
...
$arr=getData($conn,$sql);
  ...
  $cell[$i][1]=getKursusDibuka($conn,$d["kd_kursus_dibuka"]);
  $cell[$i][2]=$d["hari"];
  $cell[$i][3]=$d["waktu"];
 
  
  $cell[$i][7]=$d["mata_pelajaran"];
  $cell[$i][8]=$d["tema"];
  $cell[$i][9]=$d["guru"];
...
$pdf->Cell(7,1,'Sub Kursus','LR',0,'C',1);
$pdf->Cell(2,1,'Hari','LR',0,'C',1);
$pdf->Cell(3,1,'Waktu','LR',0,'C',1);


$pdf->Cell(6,1,'Mata Pelajaran','LR',0,'C',1);
$pdf->Cell(5,1,'Tema','LR',0,'C',1);
$pdf->Cell(3,1,'Guru','LR',0,'C',1);
...
for ($j=0;$j<$i;$j++){
  ...
  $pdf->Cell(7,1,$cell[$j][1],'B',0,'L'); // kd_kursus_dibuka
  $pdf->Cell(2,1,$cell[$j][2],'B',0,'L'); // hari
  $pdf->Cell(3,1,$cell[$j][3],'B',0,'L'); // waktu
  
 
  $pdf->Cell(6,1,$cell[$j][7],'B',0,'L'); // mata_pelajaran
  $pdf->Cell(5,1,$cell[$j][8],'B',0,'L'); // tema
  $pdf->Cell(3,1,$cell[$j][9],'B',0,'L'); // guru
